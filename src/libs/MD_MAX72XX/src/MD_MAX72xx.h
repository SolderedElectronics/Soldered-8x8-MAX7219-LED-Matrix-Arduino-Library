...
If you like and use this library please consider making a small donation using
[PayPal](https://paypal.me/MajicDesigns/4USD)
...
class MD_MAX72XX
{
  public:
    ...
    enum controlRequest_t
    {
        ...
        SCANLIMIT = 1, ///< Set the scan limit for the MAX72XX. Requires numeric value [0..MAX_SCANLIMIT]. Library
                       ///< default is all on.
        INTENSITY = 2, ///< Set the LED intensity for the MAX72XX. Requires numeric value [0..MAX_INTENSITY]. LIbrary
                       ///< default is MAX_INTENSITY/2.
        ...
        UPDATE = 10, ///< Enable or disable auto updates of the devices from the library. Requires ON/OFF value. Library
                     ///< default is ON.
     ...
     */
    inline void control(controlRequest_t mode, int value)
    {
        control(0, getDeviceCount() - 1, mode, value);
    };
    ...
    {
        return getColumn((c / COL_SIZE), c % COL_SIZE);
    };
    ...
    {
        // c = c + 1 > COL_SIZE - 1 ? 0 : c + 1;
        return setColumn((c / COL_SIZE), c % COL_SIZE, value);
    };
     ...
     * \return false if parameter errors, true otherwise.
     */
    inline bool setRow(uint8_t r, uint8_t value)
    {
        return setRow(0, getDeviceCount() - 1, r, value);
    };
     ...
     * \return false if parameter errors, true otherwise.
     */
    inline bool transform(transformType_t ttype)
    {
        return transform(0, getDeviceCount() - 1, ttype);
    };
