...
{
    Led_Matrix mx;               // object definition
...
// need to be adapted
struct LineDefinition Line[] = {{Led_Matrix(11, 13, 10, MAX_DEVICES), "abc", true},
                                {Led_Matrix(11, 13, 9, MAX_DEVICES), "def", true}};
...
// Message area is padded with blank columns after printing.
{
    ...
    Line[lineID].mx.control(modStart, modEnd, Led_Matrix::UPDATE, Led_Matrix::OFF);
    ...
    Line[lineID].mx.control(modStart, modEnd, Led_Matrix::UPDATE, Led_Matrix::ON);
}
